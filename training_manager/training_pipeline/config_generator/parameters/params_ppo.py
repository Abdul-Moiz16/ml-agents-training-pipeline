PARAMS_PPO = {
    # Hyperparameters
    "batch_size":            [32, 64, 64, 128, 128, 256], # range: 32–256 / should always be multiple times smaller than buffer_size / 3D Ball is not complex so smaller batches is fine / typical range: 512 - 5120
